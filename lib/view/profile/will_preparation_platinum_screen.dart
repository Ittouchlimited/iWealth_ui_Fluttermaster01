...
class WillPreparationPlatinumScreen extends StatefulWidget {
  const WillPreparationPlatinumScreen({super.key});

  @override
  State<WillPreparationPlatinumScreen> createState() => _WillPreparationPlatinumScreenState();
}

class _WillPreparationPlatinumScreenState extends State<WillPreparationPlatinumScreen> {
  @override
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      "Request Will Preparation Service",
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText2!
                                          .copyWith(
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                "Your Will Preparation document is\nready for download.",
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText1!
                                    .copyWith(
