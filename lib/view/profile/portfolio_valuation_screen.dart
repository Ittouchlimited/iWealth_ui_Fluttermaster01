...
class PortfolioValuationScreen extends StatefulWidget {
  const PortfolioValuationScreen({super.key});

  @override
  State<PortfolioValuationScreen> createState() => _PortfolioValuationScreenState();
}

class _PortfolioValuationScreenState extends State<PortfolioValuationScreen> {
  @override
