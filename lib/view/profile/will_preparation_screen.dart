...
class WillPreparationScreen extends StatefulWidget {
  const WillPreparationScreen({super.key});

  @override
  State<WillPreparationScreen> createState() => _WillPreparationScreenState();
}

class _WillPreparationScreenState extends State<WillPreparationScreen> {
  @override
