...
class PortfolioValuationPlatinumScreen extends StatefulWidget {
  const PortfolioValuationPlatinumScreen({super.key});

  @override
  State<PortfolioValuationPlatinumScreen> createState() => _PortfolioValuationPlatinumScreenState();
}

class _PortfolioValuationPlatinumScreenState extends State<PortfolioValuationPlatinumScreen> {
  @override
