...
class ShareAssetsSheet extends StatefulWidget {
  const ShareAssetsSheet({super.key});

  @override
  State<ShareAssetsSheet> createState() => _ShareAssetsSheetState();
}

class _ShareAssetsSheetState extends State<ShareAssetsSheet> {
  @override
