...
class ShareLiabilitiesSheet extends StatefulWidget {
  const ShareLiabilitiesSheet({super.key});

  @override
  State<ShareLiabilitiesSheet> createState() => _ShareLiabilitiesSheetState();
}

class _ShareLiabilitiesSheetState extends State<ShareLiabilitiesSheet> {
  @override
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "Share your entire liabilites data",
                          style:
