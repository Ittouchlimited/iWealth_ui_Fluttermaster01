...
import 'package:coinspace/models/stock_list_view_model.dart';
...
class StocklistViewScreen extends StatefulWidget {
  const StocklistViewScreen({super.key});

  @override
  State<StocklistViewScreen> createState() => _StocklistViewScreenState();
}

class _StocklistViewScreenState extends State<StocklistViewScreen> {
