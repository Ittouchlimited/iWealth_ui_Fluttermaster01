...
class LifeCheckerScreen extends StatefulWidget {
  const LifeCheckerScreen({super.key});

  @override
  State<LifeCheckerScreen> createState() => _LifeCheckerScreenState();
}

class _LifeCheckerScreenState extends State<LifeCheckerScreen> {
