...
import 'package:coinspace/view/market/regular_plan_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class PlatinumPlanView extends StatelessWidget {
  final String image;
  final String text1;
  final String text2;
  final String text3;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const PlatinumPlanScreen()),
        );
      },
      child: Container(
        height: 80,
